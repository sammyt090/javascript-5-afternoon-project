...
class ProgressiveManager extends Manager{
  ...
  hire(){
    ...
    this.title = "Not a manager"
    }else if(this.numChanges > 0 && this.numChanges <= 3 ){
      this.title = "Barely Manager"
    }else if(this.numChanges >= 4 && this.numChanges <= 10 ){
      this.title = "Mostly Manager"
    }else if(this.numChanges >=11 && this.numChanges <= 50){
      this.title = "Manager"
    }else if(this.numChanges >= 51 && this.numChanges <=100 ){
      this.title = "Manager Plus"
    }else if(this.numChanges > 100 ){
